...
# Idea
A sense in which an object in some category behaves as though it has a group structure. The prototypical example is that of [topological group](ntpy/topological group.md)s, which are topological spaces with a "compatible" group structure.
...
# Examples
**1** ([topological group](ntpy/topological group.md))
