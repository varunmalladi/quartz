...
$$
are continuous.
- They are precisely the [group objects](ntpy/Definitions/Category theory/group objects.md) in the category $\text{Top}$.
...
3. Every group under the [profinite topology](ntpy/profinite topology.md)
