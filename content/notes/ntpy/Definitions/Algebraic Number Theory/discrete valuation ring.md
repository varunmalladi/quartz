...
2. A [PID](ntpy/Definitions/Ring theory/Principal ideal domain.md) that is also [local](ntpy/Definitions/Ring theory/Local ring.md)
...
5. $v_\mathfrak{B}(\mathfrak{D}_{K/k})\geq e-1$ (see [different](ntpy/Definitions/Algebraic Number Theory/different.md))

# Related
- [Valuation ring](ntpy/Definitions/Ring theory/Valuation ring.md)
