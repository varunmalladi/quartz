...
**Remark.** This coincides with the notion of [Tensor product of vector spaces](ntpy/Definitions/Linear algebra/Tensor product of vector spaces.md). Notably, it suffices to consider $K=\mathbb{F}$.
