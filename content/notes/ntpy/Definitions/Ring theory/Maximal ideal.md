...
### Local rings
A ring with exactly one maximal ideal (e.g. a field) is called a [local ring](ntpy/Definitions/Ring theory/Local ring.md).

### Existence
**Theorem.** Every nonzero (commutative, with identity) ring has at least one maximal idea.

_Pf._ [Zorn's lemma](ntpy/Theorems/Zorn's lemma.md)
...
### Properties
1. Every maximal ideal is [prime](ntpy/Definitions/Ring theory/Prime ideal.md).
