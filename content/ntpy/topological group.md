...
are continuous.
- They are precisely the [group objects](notes/ntpy/Definitions/Category theory/group objects.md)<notes/ntpy/Definitions/Category theory/group objects.md>) in the category $\text{Top}$.
...
3. Every group under the [profinite topology](notes/ntpy/profinite topology.md)<notes/ntpy/profinite topology.md>)
