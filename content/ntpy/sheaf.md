...
Let $(C,J)$ be a small [site](notes/ntpy/site.md)<notes/ntpy/site.md>) (with coverage $J$).
...
See: [Holomorphic function](notes/ntpy/Definitions/Holomorphic function.md)<notes/ntpy/Definitions/Holomorphic function.md>)

**Regular functions on a variety**
Given 

[Regular map](notes/ntpy/Definitions/Algebraic geometry/Regular map.md)<notes/ntpy/Definitions/Algebraic geometry/Regular map.md>)
