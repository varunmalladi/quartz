...
# Idea
The oppose of ascent, see [base change, ascent](notes/ntpy/Key Ideas/base change, ascent.md)<notes/ntpy/Key Ideas/base change, ascent.md>). 
...
- $V\otimes_F K$ is a $K$-vector space via $\alpha(v\otimes\beta)=v\otimes \alpha\beta$. (see [base change, ascent](notes/ntpy/Key Ideas/base change, ascent.md)<notes/ntpy/Key Ideas/base change, ascent.md>)). 
