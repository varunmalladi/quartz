...
# Dual
Let $\mathcal{O}$ be a [dedekind domain](notes/ntpy/Definitions/Algebraic Number Theory/dedekind domain.md)<notes/ntpy/Definitions/Algebraic Number Theory/dedekind domain.md>), $k$ its field of fractions and $K/k$ a finite separable [field extension]()<notes/ntpy/Definitions/Algebraic Number Theory/Field Theory/Field extension.md>). Suppose $N\subset K$ is an $\mathcal{O}$-submodule.
...
# Related
- [trace](notes/ntpy/Definitions/Algebraic Number Theory/trace.md)<notes/ntpy/Definitions/Algebraic Number Theory/trace.md>)
