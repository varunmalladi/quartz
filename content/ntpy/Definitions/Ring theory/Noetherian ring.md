...
# Dimension
- dimension 0: [Artinian ring](notes/ntpy/Definitions/Ring theory/Artinian ring.md)<notes/ntpy/Definitions/Ring theory/Artinian ring.md>)
- dimension 1: includes [dedekind domain](notes/ntpy/Definitions/Algebraic Number Theory/dedekind domain.md)<notes/ntpy/Definitions/Algebraic Number Theory/dedekind domain.md>)
