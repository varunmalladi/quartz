...
**Definition.** A prime $P$ of $R$ is _associated_ to $M$ if $P$ is the [[Annihilator]] of an element of $M$. $$\text{Ass}(M)=\{\mathfrak{p}\in\text{Spec}(A)\mid \exists m\in M\text{ st }\text{Ann}(m)=\mathfrak{p}\}.$$
...
# Properties
1. Let $R$ be a [[Noetherian ring]] and let $M$ be a finitely generated nonzero $R$-module.
	...
	3. The formation of $\operatorname{Ass}M$ commutes with [[Localization of a ring|localization]]: $$ \operatorname{Ass}_{R_U}M_U=\{\mathfrak{p}\cdot R_U\mid \mathfrak{p}\in\operatorname{Ass}M\text{ and }\mathfrak{p}\cap U=\emptyset\}.$$
