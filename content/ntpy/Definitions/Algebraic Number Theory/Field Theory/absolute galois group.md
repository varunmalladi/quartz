...
# Idea
The absolute Galois group of $F$ can be thought of as the Galois group of the maximal Galois extension of $F$, namely the [separable closure](notes/ntpy/Definitions/Algebraic Number Theory/Field Theory/separable closure.md)<notes/ntpy/Definitions/Algebraic Number Theory/Field Theory/separable closure.md>) $F^\text{sep}/F$.
