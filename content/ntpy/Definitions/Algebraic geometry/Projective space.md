...
Let $S$ denote the polynomial ring $k[x_0,\dots,x_n]$ regarded as a graded ring. (See [Polynomial ring](notes/ntpy/Definitions/Ring theory/Polynomial ring.md)<notes/ntpy/Definitions/Ring theory/Polynomial ring.md>) for details.)
...
One can show that these are closed under finite unions and arbitary intersections, allowing us to define the [Zariski topology](notes/ntpy/Definitions/Algebraic geometry/Zariski topology.md)<notes/ntpy/Definitions/Algebraic geometry/Zariski topology.md>).
