...
Going "up" base fields like this is called ascent. Going "down" basefields is descent, see [Galois descent](notes/ntpy/Galois descent.md)<notes/ntpy/Galois descent.md>).
...
This is one of the motivations for working with [etale algebras](notes/ntpy/etale algebras.md)<notes/ntpy/etale algebras.md>)s instead of field extensions.
