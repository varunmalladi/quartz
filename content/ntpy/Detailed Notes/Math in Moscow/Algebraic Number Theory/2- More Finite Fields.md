...
# Lecture Notes
**[[Finite Fields of Prime Power Order|Theorem 1.7.]]** Let $p$ be prime, and $f$ be a positive integer. Let $q=p^f$. Let $\Omega$ be an algebraically closed field with characteristic $p$. Then:
...
**[[Field Characteristic and Squares|Theorem.]]** Let $p$ be prime and $f$ a positive integer. Let $K=\mathbb{F}_q$ be a field of characteristic $p$. Then 
...
**[[Legendre Symbol|Definition]].** Let $a$ be any residue modulo $p$. The Legendre symbol is 
$$
