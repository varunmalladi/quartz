...
# Idea
According to [Nullstellensatz](notes/ntpy/Theorems/Ring Theory/Nullstellensatz.md)<notes/ntpy/Theorems/Ring Theory/Nullstellensatz.md>), there is a one-to-one correspondence...

... generalize varieties so that on the left we may take arbitrary commutative rings.

# Definition
Let $R$ be a commutative ring, and $X$ a locally [ringed space](notes/ntpy/ringed space.md)<notes/ntpy/ringed space.md>).
