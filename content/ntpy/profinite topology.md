...
- A [topological group](notes/ntpy/topological group.md)<notes/ntpy/topological group.md>) $G$ is called *residually finite* if it its profinite topology is Hausdorff. 
...
In fact, Galois groups are even stronger in their topology: they are [profinite group](notes/ntpy/profinite group.md)<notes/ntpy/profinite group.md>)s.
...
2. An equivalent bases is the one consisting of all left cosets of all subgroups of finite index.
	1. Hence in the profinite topology, every finite index subgroup is open. But this is not generally true for [profinite group](notes/ntpy/profinite group.md)<notes/ntpy/profinite group.md>)s. Namely, the topologies may not agree.
